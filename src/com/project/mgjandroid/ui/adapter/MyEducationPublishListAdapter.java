 ...
 */
public class MyEducationPublishListAdapter extends BaseListAdapter<EducationInformation> implements View.OnClickListener {

    private PopupWindow mPopupWindow;
    private int mPos;
    private View.OnClickListener mListener;

    public MyEducationPublishListAdapter(int layoutId, Activity mActivity, View.OnClickListener listener) {
