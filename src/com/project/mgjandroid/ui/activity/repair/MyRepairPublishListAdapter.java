 ...
 */
public class MyRepairPublishListAdapter extends BaseListAdapter<RepairInformation> implements View.OnClickListener {

    private PopupWindow mPopupWindow;
    private int mPos;
    private View.OnClickListener mListener;

    public MyRepairPublishListAdapter(int layoutId, Activity mActivity, View.OnClickListener listener) {
