...
//	private static boolean isTest = true;
	public static final String URL_HOME_MAIN = "http://" + (BuildConfig.IS_DEBUG? "120.24.16.64":"123.56.15.86") + "/merchant/userClient?m="; //120.24.16.64正式123.56.15.86
	public static final String URL_SECOND_HAND_MAIN = "http://" + (BuildConfig.IS_DEBUG? "120.24.16.64":"123.56.15.86") + "/secondhand/userClient?m="; //120.24.16.64正式123.56.15.86
	public static final String URL_RENT_HOUSE_MAIN = "http://" + (BuildConfig.IS_DEBUG? "120.24.16.64":"123.56.15.86") + "/houselease/userClient?m="; //120.24.16.64正式123.56.15.86
	public static final String URL_EDUCATION_MAIN = "http://" + (BuildConfig.IS_DEBUG? "120.24.16.64":"123.56.15.86") + "/education/userClient?m="; //120.24.16.64正式123.56.15.86
	public static final String URL_HOME_MAKING_MAIN = "http://" + (BuildConfig.IS_DEBUG? "120.24.16.64":"123.56.15.86") + "/homemaking/userClient?m="; //120.24.16.64正式123.56.15.86
	public static final String URL_REPAIR_MAIN = "http://" + (BuildConfig.IS_DEBUG? "120.24.16.64":"123.56.15.86") + "/repair/userClient?m="; //120.24.16.64正式123.56.15.86
